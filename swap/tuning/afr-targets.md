...
## Measurement
AFR targets are only meaningful with a calibrated wideband O2 sensor. The stock narrowband sensor cannot measure actual AFR — it only indicates rich or lean of stoichiometric. See `swap/ecu-selection/wideband.md`.
