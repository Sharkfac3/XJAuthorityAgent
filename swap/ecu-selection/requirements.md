...
| Function | Why |
|---|---|
| Wideband O2 input (0–5V) | Tuning — see `swap/ecu-selection/wideband.md` |
...
3. Verify IAC support (stepper motor or plan the PWM IAC strategy — see `swap/ecu-selection/iac-strategy.md`)
4. Verify ignition output count matches your ignition setup
5. Confirm active community with XJ-specific experience
6. See platform files: `swap/ecu-selection/speeduino.md` and `swap/ecu-selection/rusefi.md`
