...
Replace with a GM coolant temp sensor (also used as IAT) — widely available, standard Chrysler/GM NTC curve, uses a standard Metri-Pack 150 2-pin connector. See `swap/wiring/connectors/metri-pack/mp150-2pin.md`.
