# Engine Interchange Index

## Purpose
Provide a routing stub for interchange decisions related to the XJ engine domain.

## Scope
Engine-related interchange guidance.
...
## Child leaves
- [junkyard-upgrades.md](junkyard-upgrades.md) — community-compiled donor engine, cooling, and intake components from junkyard upgrade threads
