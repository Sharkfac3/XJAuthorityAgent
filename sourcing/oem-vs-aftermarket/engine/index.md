# Engine Oem Vs Aftermarket Index

## Purpose
Provide a routing stub for oem vs aftermarket decisions related to the XJ engine domain.

## Scope
Selection tradeoffs for engine-system replacement parts.
