...
## Purpose
Provide a routing stub for stock XJ charging starting facts.

## Scope
Factory charging and starting hardware, circuit layout, and year-range changes.

## What belongs here
- stock charging starting architecture
