...
## Purpose
Provide a routing stub for stock XJ electrical facts.

## Scope
Stock chassis and body electrical architecture outside charging and starting specifics.

## What belongs here
- stock electrical architecture
