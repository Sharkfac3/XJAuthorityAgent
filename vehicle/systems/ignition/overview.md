...
## Purpose
Provide a routing stub for stock XJ ignition facts.

## Scope
Factory ignition architecture, trigger strategy, and stock spark-control baselines.

## What belongs here
- stock ignition architecture
