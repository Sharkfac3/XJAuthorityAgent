...
## Purpose
Provide a routing stub for stock XJ cooling facts.

## Scope
Factory cooling-system layout, fan families, and stock thermal-control architecture.

## What belongs here
- stock cooling architecture
