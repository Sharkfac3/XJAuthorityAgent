...
## Purpose
Provide a routing stub for stock XJ suspension facts.

## Scope
Factory suspension layouts, geometry baselines, and package-defined changes.

## What belongs here
- stock suspension architecture
