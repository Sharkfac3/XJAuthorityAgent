...
## Purpose
Provide a routing stub for stock XJ steering facts.

## Scope
Factory steering-system architecture, linkage families, and stock configuration differences.

## What belongs here
- stock steering architecture
