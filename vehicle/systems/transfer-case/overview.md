...
## Purpose
Provide a routing stub for stock XJ transfer case facts.

## Scope
Factory transfer-case families, engagement architecture, and stock compatibility boundaries.

## What belongs here
- stock transfer case architecture
