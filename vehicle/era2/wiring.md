...
- CPS connector split: round-pin on 1991–1992, flat-pin on 1993–1995 — see `work/swaps/ecu/wiring/connectors/packard-56/cps.md`
...
The SBEC uses two connectors (C1 primary, C2 secondary). Both must be addressed. The SBEC pinout is the most thoroughly documented of all three eras — multiple verified community pinouts exist. Cross-reference at least two sources before building the adapter harness. See `work/swaps/ecu/wiring/connectors/ecu-body/sbec.md`.

## Grounds
Run new dedicated grounds before the swap. Head-to-firewall ground is particularly important and frequently missing or corroded on Era 2 vehicles. See `work/swaps/ecu/wiring/grounds.md`.
