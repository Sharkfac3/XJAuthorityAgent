...
## AW4 interaction
The TPS signal wire is tapped by the AW4 automatic transmission TCM. The AW4 uses TPS voltage to determine shift aggressiveness and torque converter lockup timing. See `work/swaps/ecu/integration/aw4-tps.md` for full details.
