...
## IAC support
rusEFI supports 4-wire stepper motor IAC on hardware platforms with stepper driver outputs. Confirm the specific hardware platform includes stepper outputs. See `work/swaps/ecu/ecu-selection/iac-strategy.md`.
