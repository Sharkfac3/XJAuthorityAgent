...
## Required equipment
A wideband O2 sensor and controller is mandatory for WOT tuning. The narrowband sensor cannot measure AFR at WOT. See `work/swaps/ecu/sensors-and-inputs/wideband-o2.md`.
