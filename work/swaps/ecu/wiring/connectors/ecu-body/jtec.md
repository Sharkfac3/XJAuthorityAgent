...
Same approach as SBEC. JTEC connector bodies and terminals are available. Note that 2000–2001 vehicles need 3 ignition output circuits instead of 1 — plan the open source ECU selection accordingly before building the harness. See `work/swaps/ecu/ecu-selection/requirements.md`.
