...
See `work/swaps/ecu/ecu-selection/speeduino-ocelot.md` for Ocelot hardware overview and full 48-pin connector pinout.
...
WTM Tronics VR conditioner confirmed working with Renix CPS signal at cranking RPM. See `work/swaps/ecu/ecu-selection/speeduino-ocelot.md`.
...
|---|---|---|
| O2 input | Pin 17 (A1) | Connect wideband controller 0–5V output here. See `work/swaps/ecu/sensors-and-inputs/wideband-o2.md`. |
