# Transfer Case Maintenance Index

## Purpose
Route routine transfer-case fluid service and upkeep.

## Scope
Routine transfer-case fluid service and upkeep.
...
- `fluid-service/` for drain and refill work
- `linkage-checks/` for shifter and range-selection upkeep
- `seal-and-output-inspection/` for recurring leak and seal-condition checks
