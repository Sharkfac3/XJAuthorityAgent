# Brakes Maintenance Index

## Purpose
Route routine brake wear-item service and fluid upkeep.

## Scope
Routine brake wear-item service and fluid upkeep.
...
- `pad-and-shoe-service/` for normal friction-material replacement work
- `fluid-flush-and-bleed/` for brake-fluid service
- `parking-brake-service/` for adjustment and basic upkeep
