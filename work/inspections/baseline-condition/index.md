# Baseline Condition Inspections Index

## Purpose
Route condition assessment for a stock or unknown-condition xj.

## Scope
Condition assessment for a stock or unknown-condition XJ.
...
- `fluids-and-leaks/` for first-pass health assessment
- `rust-and-structure/` for body, frame-adjacent, and floor condition checks
- `mechanical-and-electrical-baseline/` for establishing what needs work before planning upgrades or repairs
