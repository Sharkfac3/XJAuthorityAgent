# Electrical Repairs Index

## Purpose
Route repair procedures for chassis and body electrical faults outside charging and starting.

## Scope
Repair procedures for chassis and body electrical faults outside charging and starting.
...
- `ground-repair/` for failed or corroded ground paths
- `lighting-circuit-repair/` for exterior and interior lighting faults
- `switch-and-relay-repair/` for common control-side electrical failures
